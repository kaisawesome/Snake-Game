...
class SNAKE:
    def __init__(self):#class constructor
        ...
        self.head_up =pygame.image.load('data/graphics/head_up.png').convert_alpha()
        self.head_down =pygame.image.load('data/graphics/head_down.png').convert_alpha()
        self.head_left =pygame.image.load('data/graphics/head_left.png').convert_alpha()
        self.head_right =pygame.image.load('data/graphics/head_right.png').convert_alpha()
        #importing body images
        self.body_vertical =pygame.image.load('data/graphics/body_vertical.png').convert_alpha()
        self.body_horizontal =pygame.image.load('data/graphics/body_horizontal.png').convert_alpha()
        self.body_tr =pygame.image.load('data/graphics/body_tr.png').convert_alpha()
        self.body_tl =pygame.image.load('data/graphics/body_tl.png').convert_alpha()
        self.body_br =pygame.image.load('data/graphics/body_br.png').convert_alpha()
        self.body_bl =pygame.image.load('data/graphics/body_bl.png').convert_alpha()
        #importing tail images
        self.tail_up =pygame.image.load('data/graphics/tail_up.png').convert_alpha()
        self.tail_down =pygame.image.load('data/graphics/tail_down.png').convert_alpha()
        self.tail_right =pygame.image.load('data/graphics/tail_right.png').convert_alpha()
        self.tail_left =pygame.image.load('data/graphics/tail_left.png').convert_alpha()
...
class FOOD:
    def __init__(self):
        self.random_pos()
        self.food_image = pygame.image.load('data/graphics/apple.png').convert_alpha()
...
class MAIN_GAME:
    ...
    def check_munch(self):
        if self.food.pos == self.snake.body[0]:
            ...
            self.snake.add_block() #add extra block to snek
...
game_font = pygame.font.Font('data/font/PoetsenOne-Regular.ttf',24)
